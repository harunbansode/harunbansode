...
I build scalable machine learning systems, production-ready APIs, and intelligent data-driven applications. Passionate about AI, Deep Learning, and deploying ML models to real-world environments.
...
Production-ready recommendation engine with model tracking and deployment pipeline.  
**Tech:** Python, PyTorch, MLflow, AWS  

### 📊 Data Science Dashboard
Interactive dashboard for real-time data insights using Streamlit & Plotly.  
**Tech:** Python, Pandas, Plotly  

### 🤖 NLP Chatbot
Transformer-based AI chatbot trained on NLP techniques.  
...
⭐️ From [harunbansode](https://github.com/harunbansode)
